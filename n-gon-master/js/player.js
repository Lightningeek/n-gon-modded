...
const m = {
    ...
    harmReduction() {
        ...
        if (tech.isFirstDer && b.inventory[0] === b.activeGun) dmg *= 0.00000000000000000000001 ** b.inventory.length
        return dmg
    },
    ...
    damage(dmg) {
        ...
        if (tech.isEnergyHealth) {
            dmg *= Math.pow(m.harmReduction(), 10000) //defense has less effect
